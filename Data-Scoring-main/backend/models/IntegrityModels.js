...
const IntegrityPrediction = sequelize.define('IntegrityPrediction', {
  ...
  historicalSeries:  { type: DataTypes.JSON, defaultValue: [] }, // [{date, score, ...dims}]
  forecastSeries:    { type: DataTypes.JSON, defaultValue: [] }, // [{date, predicted, lower, upper}]
  anomalySeries:     { type: DataTypes.JSON, defaultValue: [] }, // [{date, score, anomaly: true}]
