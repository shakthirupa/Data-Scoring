...
const CustomRule = sequelize.define('CustomRule', {
  ...
  requiredFields: { type: DataTypes.TEXT, defaultValue: '[]', get() { const v = this.getDataValue('requiredFields'); return typeof v === 'string' ? JSON.parse(v) : v; }, set(v) { this.setDataValue('requiredFields', JSON.stringify(v)); } },
...
const ConsistencyResult = sequelize.define('ConsistencyResult', {
  ...
  ruleSummary:      { type: DataTypes.JSON, defaultValue: [] },
  flaggedRows:      { type: DataTypes.JSON, defaultValue: [] },
