...
const ForensicsReport = sequelize.define('ForensicsReport', {
  ...
  eventChain:            { type: DataTypes.JSON, defaultValue: [] },
  timeline:              { type: DataTypes.JSON, defaultValue: [] },
  topIssues:             { type: DataTypes.JSON, defaultValue: [] },
  columnProfiles:        { type: DataTypes.JSON, defaultValue: [] },
  severityBreakdown:     { type: DataTypes.JSON, defaultValue: {} },
